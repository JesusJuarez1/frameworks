...
from .validadores import rfc_validador, imagen_validador, matricula_validador


class Docente(models.Model):
    matricula = models.CharField('Matrícula', max_length=50, validators=[matricula_validador])
